    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
            <div class="nav-group">
                ...
                <a href="{{ route('learn.hausa.pos') }}" class="nav-item">
                    <div class="nav-icon">🔤</div>
                    <div class="nav-text">Hausa</div>
                </a>
                <a href="{{ route('learn.yoruba.pos') }}" class="nav-item">
                    <div class="nav-icon">📝</div>
                    <div class="nav-text">Yoruba</div>
                </a>
                <a href="{{ route('learn.igbo.pos') }}" class="nav-item">
    ...
    <div class="main-content">
        <div class="dashboard-header">
            ...
            <div class="header-right">
                ...
                <button class="header-btn btn-primary" onclick="window.location='{{ route('learn.hausa.pos') }}'">Start Learning</button>
            </div>
        </div>
        ...
        <div class="learning-modules">
            ...
            <div class="modules-grid">
                <div class="module-card hausa">
                    ...
                    <a href="{{ route('learn.hausa.pos') }}" class="module-btn hausa">
                ...
                <div class="module-card yoruba">
                    ...
                    <a href="{{ route('learn.yoruba.pos') }}" class="module-btn yoruba">
                ...
                <div class="module-card igbo">
                    ...
                    <a href="{{ route('learn.igbo.pos') }}" class="module-btn igbo">
                        Start Learning Igbo
                    </a>
                    <div class="progress-stats">
